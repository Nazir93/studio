...
const I: Record<string, TapeItem> = {
  web:       { title: "Веб-сервисы",          subtitle: "Full stack",     desc: "Сайты, лендинги, порталы и SaaS-платформы. React, Next.js, Node — полный цикл от прототипа до продакшена.", tags: ["React", "Next.js", "Node"], href: "/services", image: null, video: `${V}/hover-web.mp4`, hoverLine: "От лендинга до SaaS — один контур разработки." },
  mobile:    { title: "Мобильные\nприложения", subtitle: "iOS · Android",  desc: "Нативные и кроссплатформенные приложения. Flutter, React Native, Swift — публикация в сторы.", tags: ["Flutter", "React Native", "Swift"], href: "/services", image: null, video: `${V}/hover-mobile.mp4`, hoverLine: "Публикация в сторы и обновления без сюрпризов." },
  corp:      { title: "Корпоративный софт",   subtitle: "CRM · ERP",      desc: "Внутренние системы автоматизации: CRM, ERP, склад, документооборот. Интеграция с 1С и SAP.", tags: ["CRM", "ERP", "1С"], href: "/services", image: null, video: `${V}/hover-corp.mp4`, hoverLine: "Процессы и данные в одной цифровой петле." },
  ai:        { title: "AI и автоматизация",   subtitle: "ML · GPT",       desc: "Чат-боты, рекомендательные системы, компьютерное зрение, генерация контента и предиктивная аналитика.", tags: ["GPT", "ML", "CV"], href: "/services", image: null, video: `${V}/hover-ai.mp4`, hoverLine: "Модели под ваши данные и сценарии, не наоборот." },
  design:    { title: "Продукт и\nдизайн",     subtitle: "UX / UI",        desc: "Исследования, прототипы, дизайн-системы, анимации. Figma → код без потерь.", tags: ["Figma", "UX", "Motion"], href: "/services", image: null, video: `${V}/hover-design.mp4`, hoverLine: "Из Figma — в пиксельно точный фронт." },
  /** Вторая ячейка «Продукт и дизайн» в ленте — отдельное hover-видео */
  designB:   { title: "Продукт и\nдизайн",     subtitle: "UX / UI",        desc: "Исследования, прототипы, дизайн-системы, анимации. Figma → код без потерь.", tags: ["Figma", "UX", "Motion"], href: "/services", image: null, video: `${V}/hover-design-alt.mp4`, hoverLine: "Дизайн-система, которую не стыдно масштабировать." },
  ads:       { title: "Реклама и\nрост",        subtitle: "Performance",    desc: "Таргет, контекст, SEO, SMM. Стратегия роста, A/B тесты, сквозная аналитика.", tags: ["SEO", "Таргет", "A/B"], href: "/services", image: null, video: `${V}/hover-ads.mp4`, hoverLine: "Рост измеряем цифрами, не ощущениями." },
  analytics: { title: "Аналитика",            subtitle: "Данные · BI",    desc: "Дашборды, ETL-пайплайны, BI-отчёты. Визуализация данных для принятия решений.", tags: ["BI", "SQL", "Dashboards"], href: "/services", image: null, video: `${V}/hover-analytics.mp4`, hoverLine: "Отчёты, которые закрывают споры за столом." },
  devops:    { title: "DevOps",               subtitle: "CI / CD",        desc: "Инфраструктура как код, контейнеризация, мониторинг. AWS, GCP, Yandex Cloud.", tags: ["Docker", "K8s", "AWS"], href: "/services", image: null, video: `${V}/hover-devops.mp4`, hoverLine: "Деплой по кнопке — ночной дежурный не обязателен." },
  support:   { title: "Поддержка",            subtitle: "24 / 7",         desc: "Техническая поддержка, SLA, мониторинг, быстрое реагирование на инциденты.", tags: ["SLA", "Monitoring", "Support"], href: "/services", image: null, video: `${V}/hover-support.mp4`, hoverLine: "SLA живёт в тикетах, не только в договоре." },
  consult:   { title: "Консалтинг",           subtitle: "Стратегия",      desc: "Аудит IT-инфраструктуры, выбор стека, архитектура решений, roadmap продукта.", tags: ["Аудит", "Архитектура", "Roadmap"], href: "/services", image: null, video: `${V}/hover-consult.mp4`, hoverLine: "Архитектура и дорожная карта до первой строки кода." },
  ecom:      { title: "E-commerce",           subtitle: "Магазины",       desc: "Интернет-магазины, маркетплейсы, платёжные системы, склад и логистика.", tags: ["Shopify", "WooCommerce", "API"], href: "/services", image: null, video: `${V}/hover-ecom.mp4`, hoverLine: "Корзина, оплата и склад — в одной цепочке." },
  integr:    { title: "Интеграции",           subtitle: "API · CRM",      desc: "Связываем любые системы: API, вебхуки, очереди сообщений, синхронизация данных.", tags: ["REST", "GraphQL", "Webhooks"], href: "/services", image: null, video: `${V}/hover-integr.mp4`, hoverLine: "Сервисы говорят друг с другом — без ручного копипаста." },
  security:  { title: "Безопасность",         subtitle: "Аудит",          desc: "Пентесты, аудит кода, защита данных, соответствие 152-ФЗ и GDPR.", tags: ["Pentest", "GDPR", "152-ФЗ"], href: "/services", image: null, video: `${V}/hover-security.mp4`, hoverLine: "152-ФЗ и GDPR — в чек-листах, не в панике." },
  mvp:       { title: "MVP за 2 нед.",        subtitle: "Быстрый старт",  desc: "Минимальный жизнеспособный продукт за 2 недели. Валидация гипотез без лишних затрат.", tags: ["Sprint", "Lean", "Prototype"], href: "/services", image: null, video: `${V}/hover-mvp.mp4`, hoverLine: "Две недели до первого «вау» от пользователя." },
  turnkey:   { title: "Под ключ",             subtitle: "Всё включено",   desc: "От идеи до запуска: аналитика, дизайн, разработка, тесты, деплой, поддержка.", tags: ["Full cycle", "PM", "Launch"], href: "/services", image: null, video: `${V}/hover-turnkey.mp4`, hoverLine: "Идея → прод: один подрядчик, одна ответственность." },
};
